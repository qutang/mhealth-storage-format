...
1. A local unique identifier for a specific sensor on a device. For most devices, it could be the serial number. For phone, it could also be the IMEI number.
